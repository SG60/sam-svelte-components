...
<header>
	...
	<nav>
		...
		<ul>
			...
			<li class:active={$page.url.pathname === base + '/app'}>
				<a sveltekit:prefetch href="{base}/app">App</a>
			</li>
		</ul>
		<svg viewBox="0 0 2 3" aria-hidden="true">
	...
	<div class="corner">
		<a href="https://www.github.com/sg60/block-sync"
			><SvgIcon icon={githubLogo} title="Go to GitHub" /></a
		>
		<br />
	</div>
</header>
